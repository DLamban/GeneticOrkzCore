...
public class GeneticOrkzCoreApp {

    private static final Logger log = LoggerFactory.getLogger(GeneticOrkzCoreApp.class);

    private final Environment env;

    public GeneticOrkzCoreApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes GeneticOrkzCore.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GeneticOrkzCoreApp.class);
